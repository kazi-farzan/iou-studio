...
function getModuleClasses(isSelected) {
  return [
    "group relative flex h-full cursor-pointer touch-manipulation flex-col overflow-hidden rounded-[26px] border px-5 py-5 text-left transition-[background-color,border-color,box-shadow,transform] duration-200 ease-out focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[color:var(--accent-ring)] focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--background)] motion-reduce:transition-none sm:px-6 sm:py-6",
    isSelected
...
function getMetricClasses() {
  return "min-w-[8rem] transition-colors duration-200 ease-out motion-reduce:transition-none";
}

function getActionClasses(isSelected) {
  return [
    "inline-flex min-h-[44px] items-center gap-3 self-start rounded-full border px-4 py-2 text-sm font-medium tracking-[0.01em] transition-[background-color,border-color,color] duration-200 ease-out motion-reduce:transition-none sm:self-auto",
    isSelected
      ? "border-[color:var(--border-accent)] bg-[var(--surface-accent-strong)] text-[var(--accent-contrast-text)]"
    ...
    >
      ...
      <div className="relative flex h-full flex-col">
        ...
        <div className="mt-5 flex-1 space-y-3">
          ...
          <p
            className="max-w-[40ch] text-sm leading-6 text-[var(--text-secondary)] transition-colors duration-200 ease-out motion-reduce:transition-none"
            id={descriptionId}
          >
            {module.description}
          </p>
        ...
        <div className="mt-6 border-t border-[color:var(--border-subtle)] pt-5 transition-colors duration-200 ease-out motion-reduce:transition-none">
            ...
            <dl className="flex flex-wrap gap-x-6 gap-y-3">
              ...
              {timelineHint ? (
                <div className={getMetricClasses()}>
                  ...
                  <dd className="mt-1 text-sm font-medium text-[var(--text-secondary)]">
                    {timelineHint}
                  </dd>
                </div>
              ) : null}
